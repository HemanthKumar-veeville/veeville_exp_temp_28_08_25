...
const testimonialsData = [
  {
    id: 1,
    quote: "This program looked at the business as a whole and not just leaders as individuals. It made us work through and apply our minds to problem identification, solution building approach, breakdown of tasks comprising the solution and execution thereof through devolution of responsibilities. Everything was totally relatable to our work-lives and challenges thereof, without it being contrived. Above all, this was so much fun. I will remember this wherever I go!",
    author: "VP and Head,Global IT Services- India Centre",
    company: "a 30 Bn dollar MNC"
  },
  {
    id: 2,
    quote: "No Classroom training. No models. No theory. No jargon. The people bonded, did interesting and new things together. They have taken learnings that are immediately applicable to their work. All our objectives from this intervention were met. Actually, they were exceeded beyond expectation.",
...
export default function Testimonials() {
  return (
    <>
      {/* Desktop Version */}
      <section className="hidden lg:block w-full bg-white py-[79px]">
        <div className="max-w-[1440px] mx-auto px-[69px]">
          <h2 className="font-georgia text-[80px] leading-[0.99] text-black mb-[58px]">
            Testimonials
          </h2>
          ...
          <div className="space-y-[51px] mb-[110px]">
            {testimonialsData.map((testimonial) => (
              <div key={testimonial.id}>
                <p className="font-sofia-pro font-light text-[34px] text-black leading-normal mb-[10px] max-w-[1189px]">
                  {testimonial.quote}
                </p>
